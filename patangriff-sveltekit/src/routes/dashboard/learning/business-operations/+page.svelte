<script lang="ts">
	...
	import { Building2, ArrowLeft, LogOut } from 'lucide-svelte';
...
<div class="min-h-screen bg-background">
				...
				<div class="flex items-center space-x-4">
					...
					<div class="flex items-center space-x-3">
						...
						<div>
							...
							<p class="text-sm text-foreground/70">Professional Trading Practices</p>
						</div>
					</div>
				</div>
	...
	<div class="container-max mx-auto px-6 py-8">
		<div class="text-center py-12">
			...
			<h2 class="text-2xl font-bold mb-2">Business Operations Learning</h2>
			<p class="text-muted-foreground">Professional trading practices curriculum coming soon.</p>
		</div>
	</div>
</div>