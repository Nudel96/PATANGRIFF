...
<svelte:head>
	<title>Priceactiontalk - Forge Warriors, Command Respect</title>
	<meta name="description" content="Transform from chart-watcher to market operator through systematic trading education and professional development." />
</svelte:head>
