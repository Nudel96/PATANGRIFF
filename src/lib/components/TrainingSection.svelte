<script lang="ts">
	...
	function handleViewCurriculum() {
		dispatch('viewCurriculum');
	}

	function handleUnlockPotential() {
		dispatch('unlockPotential');
	}

	function handleScheduleAssessment() {
		dispatch('scheduleAssessment');
	}
</script>
	...
	<div class="container-max mx-auto">
		...
		<div class="text-center mb-16">
			...
			<div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
				{#each progressLevels as level, index}
			...
			<div class="flex flex-col sm:flex-row items-center justify-center gap-4">
				<Button size="lg" class="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 text-lg font-semibold" on:click={handleStartTraining}>
					Start Your Training Journey
					<ArrowRight class="ml-2 w-5 h-5" />
				</Button>
				<Button variant="outline" size="lg" class="px-8 py-6 text-lg border-primary/20 hover:bg-primary/10" on:click={handleViewCurriculum}>
		...
		<div class="mb-20">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
				{#each learningFeatures as feature, index}
		...
		<div class="text-center">
			...
			<div class="flex flex-col sm:flex-row items-center justify-center gap-4">
				<Button size="lg" class="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-6 text-lg font-semibold" on:click={handleUnlockPotential}>
					Unlock Your Potential
					<Award class="ml-2 w-5 h-5" />
				</Button>
				<Button variant="outline" size="lg" class="px-8 py-6 text-lg border-secondary/20 hover:bg-secondary/10" on:click={handleScheduleAssessment}>
